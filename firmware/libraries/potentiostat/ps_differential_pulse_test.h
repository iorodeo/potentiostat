#ifndef PS_DIFFERENTIAL_PULSE_TEST_H
#define PS_DIFFERENTIAL_PULSE_TEST_H
#include "ps_base_test.h"

namespace ps 
{
    class DifferentialPulseTest : public BaseTest
    {
        public:

            DifferentialPulseTest();
            ...
            virtual uint64_t getStepCount(uint64_t t) const;
